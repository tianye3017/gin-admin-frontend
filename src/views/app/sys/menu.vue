  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="方法" prop="request_method">
          <el-input v-model="temp.request_method" />
        </el-form-item>
...
<script>
import { requestList, requestDetail, requestUpdate, requestCreate, requestAll, requestDelete } from '@/api/app/sys/menu'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        request_method: [{ required: true, message: '请输入方法', trigger: 'blur' }],
