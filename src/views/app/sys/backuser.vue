...
import { requestList, requestDetail, requestUpdate, requestCreate, requestDelete, requestUserRoleList, requestSetRole } from '@/api/app/sys/backuser'
...
export default {
  ...
  methods: {
    ...
    handleSetRole(row) {
      ...
      requestUserRoleList(this.temp.id).then(response => {
    ...
    setRole() {
      ...
      requestSetRole(this.temp.id, roleids).then(() => {
